...
class SearchUrlBuilderTest extends TestCase
{
    ...
    public function buildValidUrlTest(): void
    {
        ...
        $this->assertSame(
            'size=10&page=3&q=to+search+query&qu=1&user_id=user-id&f%5B0%5D=category%3ATop+%26+Top',
            $searchBuilder->toUrlQuery()
        );

        $searchBuilder->addFilter('category', 'Jeans');
        $this->assertSame(
            'size=10&page=3&q=to+search+query&qu=1&user_id=user-id&f%5B0%5D=category%3ATop+%26+Top&f%5B1%5D=category%3AJeans',
            $searchBuilder->toUrlQuery()
        );
        ...
        $this->assertSame(
            'size=10&page=3&q=to+search+query&qu=1&user_id=user-id&f%5B0%5D=brand%3AElo+%26+Hot16&f%5B1%5D=category%3ATop&f%5B2%5D=category%3AJeans&f%5B3%5D=price%3A5%7C2',
            $searchBuilder->toUrlQuery()
        );

        $searchBuilder->setSize(13);
        $this->assertSame(
            'size=13&page=3&q=to+search+query&qu=1&user_id=user-id&f%5B0%5D=brand%3AElo+%26+Hot16&f%5B1%5D=category%3ATop&f%5B2%5D=category%3AJeans&f%5B3%5D=price%3A5%7C2',
            $searchBuilder->toUrlQuery()
        );

        $searchBuilder->setSort('price', 'asc');
        $this->assertSame(
            'size=13&page=3&q=to+search+query&qu=1&user_id=user-id&f%5B0%5D=brand%3AElo+%26+Hot16&f%5B1%5D=category%3ATop&f%5B2%5D=category%3AJeans&f%5B3%5D=price%3A5%7C2&sort=price%3Aasc',
            $searchBuilder->toUrlQuery()
        );

        $searchBuilder->setQuicksearchTypes(['price', 'title']);
        $this->assertSame(
            'size=13&page=3&q=to+search+query&qu=1&user_id=user-id&f%5B0%5D=brand%3AElo+%26+Hot16&f%5B1%5D=category%3ATop&f%5B2%5D=category%3AJeans&f%5B3%5D=price%3A5%7C2&sort=price%3Aasc&quicksearch_types=price%2Ctitle',
            $searchBuilder->toUrlQuery()
        );

        $searchBuilder->setFacets(['brand', 'attribute']);
        $this->assertSame(
            'size=13&page=3&q=to+search+query&qu=1&user_id=user-id&f%5B0%5D=brand%3AElo+%26+Hot16&f%5B1%5D=category%3ATop&f%5B2%5D=category%3AJeans&f%5B3%5D=price%3A5%7C2&sort=price%3Aasc&quicksearch_types=price%2Ctitle&facets=brand%2Cattribute',
            $searchBuilder->toUrlQuery()
        );

        $searchBuilder->setFixits(false);
        $this->assertSame(
            'size=13&page=3&q=to+search+query&qu=1&user_id=user-id&f%5B0%5D=brand%3AElo+%26+Hot16&f%5B1%5D=category%3ATop&f%5B2%5D=category%3AJeans&f%5B3%5D=price%3A5%7C2&sort=price%3Aasc&quicksearch_types=price%2Ctitle&facets=brand%2Cattribute&use_fixits=0',
            $searchBuilder->toUrlQuery()
        );
